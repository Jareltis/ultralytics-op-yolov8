...
class DSMP(nn.Module):
    """Depth-wise Separable Convolution + MaxPooling downsampling module
    из статьи Op-YOLOv8 (Abozeid et al., 2025)
    """
    def __init__(self, c1, c2, k=3, s=2):
        ...
        self.pointwise = nn.Conv2d(
            c1, c2 // 2, kernel_size=1, stride=1,
    ...
    def forward(self, x):
        branch1 = self.pointwise(self.depthwise(x))
        branch2 = self.pool_conv(self.maxpool(x))
